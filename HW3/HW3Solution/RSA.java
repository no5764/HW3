...
public class RSA {
     ...
     */
    public static BigInteger convertFromASCII(String text) throws UnsupportedEncodingException {
    	byte[] b = text.getBytes("ASCII"); // this is my byte array of Ascii values of String "text"
	    BigInteger block = new BigInteger(b); //this is our block of ASCII values
        return block;
    }
